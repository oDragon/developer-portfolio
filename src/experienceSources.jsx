export default [
  ...
  },
  {
    ...
    link: "https://www.systemswithintelligence.com/"
  },
  {
    id: 2,
    img: "./cynorixLogo.png",
  ...
  },
  {
    ...
    desc: [
      "Designed a PID feedback control algorithm that allowed the robot’s flywheel to achieve 3000 rotations per minute",
      "Implemented a line graph that updates in real time to track the flywheel's speed",
      'Developed a 45 second autonomous routine for an 18" robot that intakes and shoots frisbees',
      "Configured a color sensor using Linux and Nvidia’s Jetson Nano that identifies colors with an accuracy of 95%",
    ],
    time: "September 2022 - April 2023",
    link: "https://www.linkedin.com/company/uw-vex-u/"
  },
];
